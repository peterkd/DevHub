...
- Optional SQL recipient inclusion by selected organization role (appended to manual recipients when selected)
- Subject field
...
The frontend loads organization role options from `GET /api/mail/organization-roles`, backed by:
